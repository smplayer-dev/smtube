...
${LangFileString} Info_Portable_Bypassed "Провера преносивости избегнута из командне линије. Форсирам преносиву."
${LangFileString} Info_Portable_Detected "Нађена је преносива верзија СМПлејера."
