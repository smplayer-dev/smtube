...
QString About::getTranslators() {
	return QString(
		...
		trad(tr("Ukrainian"), QStringList() << "Zubr139" << "evmir2" << "vitrolov" << QString::fromUtf8("Олександр")) +
		...
		trad(tr("Swedish"), QStringList() << "XC" << "Andreas Gustafsson" << "Patrik Nilsson" << "Kristian") +
